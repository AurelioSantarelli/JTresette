...
public class Tresette extends JFrame implements GameView {
     ...
     */
    public Tresette(String nomeGiocatore) {
     ...
     */
    public Tresette(String nomeGiocatore, int punteggioVittoria) {
     ...
     */
    public Tresette(String nomeGiocatore, int punteggioVittoria, boolean modalitaDueGiocatori) {
        super("JTresette!");
